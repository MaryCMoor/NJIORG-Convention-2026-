...
const ManageGallery = () => {
  ...
  const resetForm = () => setFormData({title:'',description:'',category:'General',imageUrl:'',videoUrl:'',mediaType:'image',thumbnailUrl:'',featured:false,tags:'',displayOrder:0,date:new Date().toISOString().split('T')[0]});
